    ...
    <div class="max-w-7xl mx-auto flex items-center">
        ...
        <div class="ml-auto flex items-center space-x-4">
            <div class="flex space-x-3 items-center">
                <button class="bg-white/10 border-0 h-auto w-1/3 p-2 flex items-center justify-center rounded-full">
            ...
            <a href="#" class="devcon-gradient p-0.5 rounded-full uppercase tracking-wide font-semibold">
                <span class="inline-block bg-[#1C133E] px-6 py-1.5 text-white rounded-full space-x-4 flex items-center">
