...
<div class="devcon-default-bg">
                ...
                <div class="faqs flex flex-col">
                    <?php foreach ($faq as $idx => $faqItem) { ?>
                        <div class="faq-item border-x border-b border-white/20 bg-white/10 transition-colors hover:bg-white/30 <?php echo $idx == 0 ? "border-t rounded-t-lg" : ( $idx == count( $faq ) - 1 ? " rounded-b-lg" : "" ) ?>">
                            ...
                            <div class="faq-answer mt-0 pl-3 pr-8 ml-8 mb-6 border-l border-[#A8E54E]">
    ...
    <section class="py-24">
        ...
        <div class="container flex flex-col items-center">
           ...
           <a href="<?php echo devcon_msummit2024_get_theme_mod('cta_button_url'); ?>" class="w-1/3 text-center bg-white rounded-lg text-black uppercase font-bold tracking-wide border-0 py-3 text-sm mt-16 self-center">
	           Register Now
           </a>
        </div>
    </section>
