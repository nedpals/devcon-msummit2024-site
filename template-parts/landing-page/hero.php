	...
	<div class="<?php if ($args['background_waves']) { ?>relative<?php } ?> <?php echo $args['container_width_class'] ?> <?php echo $args['inner_container_padding'] ?> <?php if ($args['divider']) { ?>border-b border-white/25<?php } ?>">
		<div class="w-full lg:w-3/4">
			<div class="space-y-10">
				...
				<div class="flex flex-col items-start xl:flex-row space-y-4 xl:space-y-0 xl:space-x-4 text-sm">
					<?php if (!empty($args['event_location'])) { ?>
                        <div class="flex space-x-2 border border-white/20 bg-white/10 backdrop-blur-md rounded-lg uppercase tracking-widest px-4 py-3 w-full md:w-auto">
            ...
            <?php if (!empty($args['cta_button_text'])) { ?>
                <a href="<?php echo $args['cta_button_url'] ?>" class="inline-block btn btn-primary mt-4 md:mt-16 w-full md:w-auto text-center md:text-left">
